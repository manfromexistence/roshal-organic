...
## Last Updated
2026-04-27 - Removed sub-header scrolling from the storefront in favor of a non-scrolling curated quick-category rail, normalized Roshal product/public image paths so landing and product cards stop breaking previews, and re-verified the live storefront plus build pipeline locally
