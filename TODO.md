...
## Last Updated
2026-04-26 - Stabilized Better Auth sign-in/sign-out handoff for Roshal customer/admin flows, removed build-time Google font dependencies, and re-verified the protected storefront/dashboard route matrix locally
