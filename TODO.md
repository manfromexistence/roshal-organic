...
## Last Updated
2026-04-26 - Transplanted the old `marketting` landing/header/footer shell into the active storefront, removed the legacy `marketting` folder, visually smoke-checked the copied experience locally, and tightened the copied sub-header/card spacing polish
