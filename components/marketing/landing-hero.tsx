  ...
  return (
    <section className="w-full overflow-x-clip bg-background pb-2 pt-22 lg:pt-32">
      <div className="container mx-auto space-y-5 px-4 sm:px-6 md:px-8">
        <div className="grid grid-cols-2 gap-5 md:grid-cols-[1.45fr_0.85fr]">
          <Card className="gap-0 overflow-hidden rounded-md border-border/70 bg-card p-0 shadow-sm">
            <CardContent className="relative min-h-[300px] p-0 sm:min-h-[13rem] md:min-h-[14rem]">
              <Image
              ...
              <div className="relative flex min-h-[8rem] max-w-full flex-col justify-center gap-4 p-5 min-h-[16rem] sm:p-6 min-h-[20rem] md:max-w-xl md:gap-5 md:p-9">
          ...
          <Card className="gap-0 overflow-hidden rounded-md border-border/70 bg-card p-0 shadow-sm">
            <CardContent className="relative min-h-[14rem] p-0">
              <Image
              ...
              <div className="relative flex min-h-[14rem] flex-col justify-end gap-3 p-5 min-h-[20rem] md:gap-4 md:p-8">
