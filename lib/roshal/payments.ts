import { getRoshalAbsoluteUrl } from "./site";
import type {
...
export function getRoshalPaymentGatewaySummary(): RoshalPaymentGatewaySummary {
  ...
  return {
    ...
    callbackUrls: {
      success: getRoshalAbsoluteUrl("/api/roshal/payments/aamarpay/success"),
      fail: getRoshalAbsoluteUrl("/api/roshal/payments/aamarpay/fail"),
      cancel: getRoshalAbsoluteUrl("/api/roshal/payments/aamarpay/cancel"),
      ipn: getRoshalAbsoluteUrl("/api/roshal/payments/aamarpay/ipn"),
    },
  };
}
