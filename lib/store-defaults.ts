...
export const defaultRoshalSiteSettings: RoshalSiteSettings = {
  ...
  deliveryZones: [
    ...
    },
    {
      ...
      label: localizedValue("ঢাকার বাইরে", "Outside Dhaka"),
      fee: 120,
      cityPatterns: [],
      postalCodes: [],
      addressKeywords: [],
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        body: localizedValue(
          "দ্রুত order update, payment reference বা short support message শেয়ার করার জন্য।",
          "Best for sharing order updates, payment references, or a quick support message.",
        ),
...
export const defaultRoshalPaymentSettings: RoshalPaymentSettings = {
  ...
  manualReviewNotice: localizedValue(
    "পেমেন্ট করার পর সেন্ডার নম্বর ও ট্রানজেকশন আইডি দিন। অ্যাডমিন যাচাই করে অর্ডার কনফার্ম করবে।",
    "Submit your transaction ID and sender number after payment. An admin will verify it before the order is confirmed.",
  ),
  ...
  options: [
    ...
    },
    {
      ...
      accountNumber: "",
      instructions: localizedValue(
        "ড্যাশবোর্ড থেকে বিকাশ নাম্বার ও রেফারেন্স নির্দেশনা আপডেট করুন। গ্রাহক সেন্ডার নম্বর ও ট্রানজেকশন আইডি দেবে।",
        "Update the bKash number and reference instructions from the dashboard. Ask customers to submit their transaction ID and sender number.",
      ),
      guideImageUrl: "",
      requiresProof: false,
      sortOrder: 2,
    },
    {
      ...
      accountNumber: "",
      instructions: localizedValue(
        "ড্যাশবোর্ড থেকে নগদ নাম্বার ও গাইড আপডেট করুন। গ্রাহক ট্রানজ্যাকশন আইডি এবং সেন্ডার নম্বর জমা দেবে।",
        "Update the Nagad number from the dashboard. Customers will submit their transaction ID and sender number.",
      ),
      guideImageUrl: "",
      requiresProof: false,
      sortOrder: 3,
